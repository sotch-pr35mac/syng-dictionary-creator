#![warn(missing_docs)]
// Keep the complete versioned reader/writer contract together even though the
// generator does not exercise every consumer-facing accessor in production.
#![allow(dead_code)]

//! Generator-local normalization and binary container support for Syng English search.
