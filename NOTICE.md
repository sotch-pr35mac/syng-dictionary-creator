...
The generated bundle is an adapted database licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/). See `LICENSE-DATA`. CC BY-SA 3.0 permits an adapter to apply a later BY-SA license with the same license elements, allowing Chinese Notes material to be combined with the CC BY-SA 4.0 sources under this adapter's license.
